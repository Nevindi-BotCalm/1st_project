                    ...
                    <div className="flex space-x-4 justify-center md:justify-start">
                        {socialLinks.map((social, index) => (
                            <a
                                key={index}
                                href={social.href}
                                className="w-10 h-10 flex items-center justify-center rounded-full shadow-md hover:bg-gray-100 transition-colors duration-200 bg-gray-50 cursor-pointer"
                            >
                                <i className={`${social.icon} text-gray-700 text-lg`}></i>
                            </a>
                        ))}
                    </div>
                </div>
